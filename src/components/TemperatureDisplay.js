  ...
  return (
    <>
      <div className="weatherContainer">
        <span className='weatherItem clickable' id='temperature' onClick={toggleIsOpen}>
        ...
        <span className='weatherItem clickable' id='temperatureHigh' onClick={toggleIsOpen}>
        ...
        <span className='weatherItem clickable' id='temperatureLow' onClick={toggleIsOpen}>
        ...
        <span className='weatherItem clickable' id='temperatureFeel' onClick={toggleIsOpen}>
